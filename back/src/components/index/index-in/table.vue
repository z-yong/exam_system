<template>
    <div class="table-wrapper">
        <div v-if="myTableData.length != 0" class="table-box">
            ...
            <div id="table">
                <template>
                    <el-table :highlight-current-row="true" :data="myTableData" border style="width: 100%">
                        <el-table-column fixed prop="real_name" label="学生" min-width="10px"></el-table-column>
                        <el-table-column prop="user_name" label="学号" :min-width="isQual ? '20px' : '22.5px'"></el-table-column>
                        <el-table-column  prop="time" label="近期考试时间" :min-width="isQual ? '20px' : '22.5px'"></el-table-column>
                        <el-table-column prop="shijuan" label="试卷名称" :min-width="isQual ? '20px' : '22.5px'"></el-table-column>
        ...
        <div v-else class="no_table">暂无考试记录</div>
    </div>
</template>
